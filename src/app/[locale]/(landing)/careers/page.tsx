            ...
            <main className="max-w-5xl mx-auto px-6 py-20">
                ...
                <section className="grid md:grid-cols-3 gap-8 mb-20">
                    {[
                        ...
                        <div key={i} className="p-8 bg-zinc-50 rounded-2xl border border-zinc-100">
                            <item.icon className="h-8 w-8 text-[#15a4e6] mb-4" />
                ...
                <section>
                    ...
                    <div className="space-y-4">
                        {jobs.map((job) => (
                            <div key={job.id} className="flex items-center justify-between p-6 border border-zinc-200 rounded-xl hover:border-[#15a4e6] transition">
                                <div>
                                ...
                                <button className="bg-zinc-900 text-white px-6 py-2 rounded-lg font-semibold hover:bg-[#15a4e6] transition">
                                    {t("jobs.apply")}
                                </button>
                            </div>
                        ))}
                ...
                <section className="mt-20 text-center p-12 bg-[#15a4e6]/5 rounded-3xl border border-[#15a4e6]/20">
                    <h3 className="text-2xl font-bold mb-4">{t("spontaneous.title")}</h3>
                    <p className="text-zinc-600 mb-6">{t("spontaneous.text")}</p>
                    <a href="mailto:rh@guenstravel.com" className="text-[#15a4e6] font-bold underline hover:no-underline">
                        rh@guenstravel.com
                    </a>
                </section>
