        ...
        <div className="bg-white p-8 rounded-3xl border border-zinc-200 shadow-xl">
            <div className="mb-6">
                ...
                <div className="flex items-baseline gap-2">
                    <span className="text-4xl font-black text-[#15a4e6]">{price?.toLocaleString()}</span>
            ...
            <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                    <input type="date" className="p-3 border border-zinc-200 rounded-xl focus:ring-2 ring-[#15a4e6] outline-none" />
                    <input type="date" className="p-3 border border-zinc-200 rounded-xl focus:ring-2 ring-[#15a4e6] outline-none" />
                </div>

                <Button className="w-full h-14 bg-[#15a4e6] hover:bg-[#167c3a] text-lg font-bold rounded-xl shadow-lg shadow-[#15a4e6]/20">
