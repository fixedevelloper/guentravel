                ...
                <Card className="w-full max-w-xl rounded-3xl border-zinc-200 shadow-sm bg-white overflow-hidden">
                    <CardContent className="p-6 md:p-10 space-y-6">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                            ...
                            <Button
                                type="submit"
                                className="w-full bg-[#1d9e4b] hover:bg-[#167c3a] text-white rounded-xl text-xs font-bold h-11 shadow-sm gap-1.5 transition-all pt-1"
                        ...
                        <div className="pt-4 border-t border-zinc-100 text-center text-xs font-semibold text-zinc-500">
                            ...
                            <Link href="/host-portal/login" className="text-[#1d9e4b] hover:underline font-bold">
                                {t.loginBtn}
                            </Link>
                        </div>
